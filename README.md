...
- Firebase Auth · Firestore · Storage (단일 프로젝트: `dash-10aa1`)
- Dash 시그니처 색상(#8B5CF6)을 반영한 경량 커스텀 스타일
...
4. Firebase Hosting 대상(`dash-admin`)을 구성하고 `firebase deploy --only hosting:dash-admin`으로 배포합니다.
